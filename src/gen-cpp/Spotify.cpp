...
uint32_t Spotify_initiateSession_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Spotify_initiateSession_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("Spotify_initiateSession_args");
...
uint32_t Spotify_initiateSession_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("Spotify_initiateSession_pargs");
  xfer += oprot->writeFieldBegin("cred", ::apache::thrift::protocol::T_STRUCT, 1);
  xfer += (*(this->cred)).write(oprot);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldStop();
...
uint32_t Spotify_initiateSession_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Spotify_initiateSession_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Spotify_initiateSession_result");
...
uint32_t Spotify_initiateSession_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void SpotifyClient::initiateSession(SpotifyCredential& _return, const SpotifyCredential& cred)
{
  send_initiateSession(cred);
  recv_initiateSession(_return);
}

void SpotifyClient::send_initiateSession(const SpotifyCredential& cred)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("initiateSession", ::apache::thrift::protocol::T_CALL, cseqid);

  Spotify_initiateSession_pargs args;
  args.cred = &cred;
  args.write(oprot_);
...
void SpotifyClient::recv_initiateSession(SpotifyCredential& _return)
{
  ...
  if (fname.compare("initiateSession") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  Spotify_initiateSession_presult result;
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "initiateSession failed: unknown result");
}
...
void SpotifyProcessor::process_initiateSession(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("Spotify.initiateSession", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "Spotify.initiateSession");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "Spotify.initiateSession");
  }

  Spotify_initiateSession_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "Spotify.initiateSession", bytes);
  }

  Spotify_initiateSession_result result;
  try {
    iface_->initiateSession(result.success, args.cred);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "Spotify.initiateSession");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("initiateSession", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "Spotify.initiateSession");
  }

  oprot->writeMessageBegin("initiateSession", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "Spotify.initiateSession", bytes);
  }
}
